/* ===== Original inline script 1 from coming-soon.html ===== */
(function() {
...
document.getElementById('notifyForm').addEventListener('submit',e=>{e.preventDefault();document.getElementById('message').classList.add('show');document.getElementById('email').value=''});
})();

/* ===== Original inline script 2 from coming-soon.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 3 from coming-soon.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 4 from coming-soon.html ===== */
(function() {
