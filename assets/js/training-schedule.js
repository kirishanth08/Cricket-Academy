/* ===== Original inline script 1 from training-schedule.html ===== */
(function() {
const filter=document.getElementById('statusFilter');filter.onchange=()=>document.querySelectorAll('.session').forEach(x=>x.style.display=(filter.value==='all'||x.dataset.status===filter.value)?'grid':'none');
})();

/* ===== Original inline script 2 from training-schedule.html ===== */
(function() {
...
/* ===== Original inline script 3 from training-schedule.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 4 from training-schedule.html ===== */
(function() {
(function(){
