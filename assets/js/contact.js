/* ===== Original inline script 1 from contact.html ===== */
(function() {
...
document.getElementById('contactForm').addEventListener('submit',e=>{e.preventDefault();document.getElementById('successMessage').classList.add('show');e.target.reset()});
...
/* ===== Original inline script 2 from contact.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 3 from contact.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 4 from contact.html ===== */
(function() {
