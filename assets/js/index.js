/* ===== Original inline script 1 from index.html ===== */
(function() {
const body = document.body;
    ...
    // Theme
    const savedTheme = localStorage.getItem('eca-theme');
    if (savedTheme === 'dark') {
    ...
    window.addEventListener('scroll', () => {
      navWrap.classList.toggle('scrolled', window.scrollY > 25);
    });
...
/* ===== Original inline script 2 from index.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 3 from index.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 4 from index.html ===== */
(function() {
