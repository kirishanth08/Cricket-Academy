/* ===== Original inline script 1 from notifications.html ===== */
(function() {
function refresh(){document.getElementById('unreadCount').textContent=document.querySelectorAll('.notice.unread').length}
document.querySelectorAll('.mark-read').forEach(b=>b.onclick=()=>{b.closest('.notice').classList.remove('unread');b.remove();refresh()});
document.getElementById('markAll').onclick=()=>{document.querySelectorAll('.notice.unread').forEach(n=>n.classList.remove('unread'));document.querySelectorAll('.mark-read').forEach(b=>b.remove());refresh()};
})();

/* ===== Original inline script 2 from notifications.html ===== */
(function() {
...
/* ===== Original inline script 3 from notifications.html ===== */
(function() {
(function(){
...
/* ===== Original inline script 4 from notifications.html ===== */
(function() {
(function(){
